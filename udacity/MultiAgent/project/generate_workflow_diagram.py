...
def create_workflow_diagram():
    ...
    ax.text(5, 7.7, "• Delegates to managed agents", ha='center', va='center', fontsize=8)
    ax.text(5, 7.55, "• No direct tool access", ha='center', va='center', fontsize=8)
    ...
    ax.add_patch(arrow2)
    ax.text(2.8, 7.3, "Delegate to\nInventory Agent", ha='center', va='center', 
    ...
    arrow3 = FancyArrowPatch((5, 7.5), (4.75, 7.0),
                            ...
                            color='green', linestyle='--')
    ax.add_patch(arrow3)
    ax.text(5.2, 7.3, "Delegate to\nQuote Agent", ha='center', va='center', 
            fontsize=8, bbox=dict(boxstyle='round', facecolor='white', alpha=0.7))
    ...
    arrow4 = FancyArrowPatch((5.8, 7.5), (7.7, 7.0),
                            ...
                            color='green', linestyle='--')
    ax.add_patch(arrow4)
    ax.text(7.0, 7.3, "Delegate to\nSales Agent", ha='center', va='center', 
            fontsize=8, bbox=dict(boxstyle='round', facecolor='white', alpha=0.7))
