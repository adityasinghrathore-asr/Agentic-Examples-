...
def create_word_document():
    ...
    achievements = [
        "Four-Agent Architecture: Implemented a coordinated system with 1 orchestrator delegating to 3 specialized agents",
        ...
        "Managed Agent Delegation: Orchestrator uses managed_agents for proper coordination"
    ]
