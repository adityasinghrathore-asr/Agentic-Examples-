...
class ScientistAgent(ToolCallingAgent):
    ...
    def refresh_resources(self):
        ...
        print(f"\n🔄 Scientist Resources Refreshed! Food: {self.food_supply}, Tool: {self.toy_available}")
    ...
    def respond_to_action(self, penguin: 'PenguinAgent', action_details: Dict[str, Any]) -> None:
        ...
        print(f"Scientist Resources (before): Food: {self.food_supply}, Tool: {self.toy_available}")
...
def run_simulation():
    ...
    for penguin in penguins:
        ...
        print(f"{penguin.name} - Total Food: {penguin.food}, Has Tool: {history['has_been_recorded_with_tool']}")
